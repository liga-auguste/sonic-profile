...
function buildMergedArtists(topArtists) {
  const map = new Map();
  ...
  return Array.from(map.values()).sort((a, b) => {
    ...
    return Math.min(...Object.values(a.ranges)) - Math.min(...Object.values(b.ranges));
  });
}

function RangePills({ ranges }) {
  return (
  ...
  return (
    ...
    >
      <div className="artist-portrait">
        ...
        <div className="artist-rank-badge">#{Math.min(...Object.values(a.ranges))}</div>
      </div>
